...
module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED){
  ...
  var TAG        = NAME + ' Iterator'
    ...
    , entriesNestedCheck = !DEF_VALUES ? $default : getMethod('entries')
    , $entries   = DEFAULT ? entriesNestedCheck : undefined
...
module.exports = function(TO_STRING){
  return function(that, pos){
    ...
    a = s.charCodeAt(i);
    var nestedCheck1 = TO_STRING ? s.charAt(i) : a;
    var nestedCheck2 = TO_STRING ? s.slice(i, i + 2) : (a - 0xd800 << 10) + (b - 0xdc00) + 0x10000;
    return a < 0xd800 || a > 0xdbff || i + 1 === l || (b = s.charCodeAt(i + 1)) < 0xdc00 ||
      b > 0xdfff ? nestedCheck1 : nestedCheck2;
  };
};
...
_dereq_(77)('isExtensible', function($isExtensible){
  return function isExtensible(it){
    var nestedCheck1 = $isExtensible ? $isExtensible(it) : true;
    return isObject(it) ? nestedCheck1 : false;
  };
});
...
_dereq_(77)('isFrozen', function($isFrozen){
  return function isFrozen(it){
    var nestedCheck1 = $isFrozen ? $isFrozen(it) : false;
    return isObject(it) ? nestedCheck1 : true;
  };
});
...
_dereq_(77)('isSealed', function($isSealed){
  return function isSealed(it){
    var nestedCheck1 = $isSealed ? $isSealed(it) : false;
    return isObject(it) ? nestedCheck1 : true;
  };
});
...
$export($export.P + $export.U + $export.F * _dereq_(33)(function(){
  ...
  slice: function slice(start, end){
    ...
    var len    = anObject(this).byteLength
      ...
      , final1 = toIndex(end === undefined ? len : end, len)
      , result = new (speciesConstructor(this, $ArrayBuffer))(toLength(final1 - first))
...
var ordinaryMetadataKeys = function(O, P){
  ...
  var nestedCheck1 = oKeys.length ? from(new Set(oKeys.concat(pKeys))) : pKeys;
  return pKeys.length ? nestedCheck1 : oKeys;
};
...
},{"./libs/lib":2}],2:[function(require,module,exports){
"use strict";
